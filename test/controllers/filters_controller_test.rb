...
class FiltersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create filter" do
    assert_difference("Filter.count") do
      post filters_url, params: { filter: { description: @filter.description, term: @filter.term, title: @filter.title } }
    end
  ...
  test "should update filter" do
    patch filter_url(@filter), params: { filter: { description: @filter.description, term: @filter.term, title: @filter.title } }
